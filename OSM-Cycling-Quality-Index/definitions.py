...
from parameter import right_hand_traffic
...
def deriveSeparation(feature, traffic_mode):
    ...
    if traffic_mode == 'foot':
        ...
        else:  # Left-hand traffic
            if traffic_mode_right == 'foot':
                separation = separation_right
            if not traffic_mode_left or traffic_mode_left == 'foot':
                separation = separation_left
    ...
    if traffic_mode == 'motor_vehicle':
        if right_hand_traffic:
            ...
            if traffic_mode_left in ['motor_vehicle', 'parking', 'psv']:
                separation = separation_left
            if not traffic_mode_right or traffic_mode_right in ['motor_vehicle', 'parking', 'psv']:
                separation = separation_right
